...
void generate_identity_keys(unsigned char *public_key,
...
int main() {
  ...
  unsigned char signed_pre_key_private_A[crypto_scalarmult_BYTES],
      signed_pre_key_public_A[crypto_scalarmult_BYTES],
      signature_A[crypto_sign_BYTES];
  unsigned char signed_pre_key_private_B[crypto_scalarmult_BYTES],
      signed_pre_key_public_B[crypto_scalarmult_BYTES],
      signature_B[crypto_sign_BYTES];

  unsigned char pre_key_private_A[crypto_scalarmult_BYTES],
      pre_key_public_A[crypto_scalarmult_BYTES];
  unsigned char pre_key_private_B[crypto_scalarmult_BYTES],
      pre_key_public_B[crypto_scalarmult_BYTES];

  unsigned char ephemeral_private_A[crypto_scalarmult_BYTES],
      ephemeral_public_A[crypto_scalarmult_BYTES];
  unsigned char ephemeral_private_B[crypto_scalarmult_BYTES],
      ephemeral_public_B[crypto_scalarmult_BYTES];
  ...
  generate_signed_pre_keys(signed_pre_key_public_A, signed_pre_key_private_A,
                           signature_A, identity_private_A);
  generate_signed_pre_keys(signed_pre_key_public_B, signed_pre_key_private_B,
                           signature_B, identity_private_B);
